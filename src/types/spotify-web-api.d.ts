export interface SpotifyAccessToken {
  ...
  scope: string; // A space-separated list of scopes which have been granted for this access token
 ...
 */
export export interface UsersQueueResponse {
...
export interface addBannedSong {
  TrackID: string;
  TrackName: string;
  Artists: string[];
  ChannelID: number;
...
export interface HandeleBannedSong extends addBannedSong {
  banned: boolean
}